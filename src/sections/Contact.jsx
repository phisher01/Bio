          ...
          <div className="px-8 py-10 md:px-12 md:py-12">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-5 py-2.5 text-sm font-semibold text-blue-700 transition hover:bg-blue-100 hover:shadow-sm"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 rounded-full border border-pink-200 bg-gradient-to-r from-pink-50 to-rose-50 px-5 py-2.5 text-sm font-semibold text-pink-700 transition hover:from-pink-100 hover:to-rose-100 hover:shadow-sm"
              >
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
